...
import { Github, Twitter, Linkedin, Copy } from "lucide-react";
...
// Dynamic import for MDX components based on slug
const MDXComponents: { [key: string]: any } = {
  'exploring-wonders-of-nature': dynamic(() => import('@/markdown/welcome.mdx')),
  'rust-webassembly-web-apps': dynamic(() => import('@/markdown/rust-webassembly.mdx')),
  'functional-programming-ocaml': dynamic(() => import('@/markdown/ocaml-functional-programming.mdx')),
...
export default function BlogPostSlugPage({ params }: BlogPostPageProps) {
  // State
  ...
  const postMetadata = getBlogPostBySlug(params.slug);
  ...
  const MDXComponent = MDXComponents[params.slug];
          ...
          <div className="max-container padding-container w-full flex justify-center">
            <div className="max-w-[80ch] w-full mx-auto py-12">
              ...
              <div className="text-fg1 text-sm mb-8">
                {postMetadata.date.toLocaleDateString("en-US", {
                  year: "numeric",
                  month: "long",
                  day: "2-digit",
                })}
        ...
        <div className="w-full max-w-[80ch] mx-auto">
          ...
          <div className="mt-12 p-6 bg-bg2 border-l-4 border-accent1 max-w-[80ch] mx-auto">
            ...
            <p className="text-sm text-fg1 leading-relaxed">
              Written by {postMetadata.author} on {postMetadata.date.toLocaleDateString("en-US", {
                year: "numeric",
                month: "long",
                day: "2-digit",
              })}
